...
public class ClientApi {
    ...
    @GetMapping("/api/rate")
    public Flux<Product> rateLimiting(@RequestParam("requests") int numRequests, @RequestParam("delay") long delay) {
            ...
            .flatMap(t ->
                    webClient.get()
                            ...
                            .onErrorResume(
                                    ...
                                    throwable -> { LOG.info("Got {}", ((WebClientResponseException) throwable).getStatusCode()) ;return Mono.just(new Product()); })
                            //.log()
            );
    }
}
